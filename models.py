...
class Education(BaseModel):
    university_name: Optional[str] = Field(default=None, description="Name of the university")
...
class Experience(BaseModel):
    ...
    # Yahan float ki jagah str use karein
    years: Optional[str] = Field(default=None, description="Duration of experience, e.g., '2 years' or 'Jan 2024 - Dec 2024'")
...
class Resume(BaseModel):
    # Field ko Optional banayein aur default None set karein
